...
export default async function Projects() {
  ...
  const [featuredWorkProject1, featuredWorkProject2, proj1, proj2, proj3, ...projects] = workProjects
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 md:space-y-16 md:pt-24 lg:px-8 lg:pt-32">
        <section className="space-y-8">
          ...
          <div className="mx-auto grid grid-cols-1 gap-8 lg:grid-cols-2">
            <ProjectCard project={featuredWorkProject1} showImage />
            <ProjectCard project={featuredWorkProject2} showImage />
          </div>
          <div className="columns-1 gap-5 sm:columns-2 sm:gap-8 xl:columns-3 [&>div:not(:first-child)]:mt-8">
            {[proj1, proj2, proj3].map((project: any) => (
